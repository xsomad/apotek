      ...
      <div class="x_content">
        ...
        <form action="<?php echo base_url(). 'example/update_unit'; ?>" method="post" class="form-horizontal form-label-left" novalidate >
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_unit">Nama Unit</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="hidden" name="id_unit" value="<?php echo $u->id_unit ?>">
              <input type="text" id="nama_unit" name="nama_unit" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" required="required" value="<?php echo $u->nama_unit ?>">
            </div>
          </div>
